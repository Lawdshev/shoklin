...
function MyOrders() {
  ...
  return (
    <div className='flex flex-col items-center justify-around lg:flex-row p-4 min-h-screen'>
        <div className='bg-[#54d2d2] w-full flex flex-col items-center h-screen lg:w-2/5 p-4 ml-2'>
          <div className="flex  flex-col items-center w-full justify-around text-xl font-bold">
            ...
            <h3 className='text-white mt-2'>Welcome {customer.name}</h3>  
          </div>
          ...
          <button className='text-[#54d2d2] mt-2 rounded-lg p-2 bg-white'>Edit Information</button>
        </div>
