...
function Ironing() {
  ...
  return (
    <div className='min-h-screen p-4 flex flex-col items-center'>
      ...
      <h2 className='mt-2'>Choose the categories of the clothes you have for Ironing and their quantities, we'll give you an estimate right before you place your Order</h2>
