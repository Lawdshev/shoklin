...
function Hero2() {
  return (
    <div className='h-screen relative flex justify-center bg-[#ffffff]'>
        ...
        <div className='w-full lg:mt-44 flex flex-col lg:flex-row md:items-center md:justify-center' >
            ...
            <div className='w-full lg:w-2/4 h-96 p-4 justify-around flex flex-col py-4'>
                ...
                <div className="flex flex-col justify-around md:text-xl">
                <span className='flex items-center justify-around w-full md:w-3/5'>
